...
int main(int argc, char** argv) {
  ...
  vector<Line<FT>> resLLP, resLL2P, resLLCV, resRLP, resRL2P, resRLCV, resbLLP, resbLL2P, resbLLCV, resbRLP, resbRL2P,
      resbRLCV;
  vector<LineSegment<FT>> resLLSP, resLLS2P, resLLSCV, resRLSP, resRLS2P, resRLSCV, resbLLSP, resbLLS2P, resbLLSCV,
      resbRLSP, resbRLS2P, resbRLSCV;
