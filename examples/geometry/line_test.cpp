...
int main(int argc, char** argv)
{
    ...
    std::cout << "l1.angle: " << l1.angle() / CV_PI * 180 << ", l1.nangle: " << l1.normalAngle() / CV_PI * 180 << ", l1.dist: " << l1.originDist() << std::endl;
    std::cout << "l2.angle: " << l2.angle() / CV_PI * 180 << ", l2.nangle: " << l2.normalAngle() / CV_PI * 180 << ", l2.dist: " << l2.originDist() << std::endl;
   ...
   /* cv::Mat img(500, 500, CV_8UC3);
    ...
    std::cout << "error: " << line.error(gtline) << " errorSED: " << line.errorSED(gtline) << " angle: " << line.anglef() << std::endl;
