...
class rosen_model {
 ...
 public:
  ...
  double operator()(const column_vector& x) const { return rosen(x); }
...
int main() {
  try {
    ...
    find_min_using_approximate_derivatives(bfgs_search_strategy(), objective_delta_stop_strategy(1e-7), rosen,
                                           starting_point, -1);
    ...
    starting_point = -94, 5.2;
    find_min_using_approximate_derivatives(lbfgs_search_strategy(10), objective_delta_stop_strategy(1e-7), rosen,
                                           starting_point, -1);
    cout << "rosen solution: \n" << starting_point << endl;
    ...
    find_min_box_constrained(lbfgs_search_strategy(10), objective_delta_stop_strategy(1e-9), rosen, rosen_derivative,
    ...
    find_min_box_constrained(bfgs_search_strategy(), objective_delta_stop_strategy(1e-9), rosen, derivative(rosen),
                             starting_point, 0.1, 0.8);
    cout << endl << "constrained rosen solution: \n" << starting_point << endl;
    ...
    starting_point = 0.8, 1.3;
    find_min(newton_search_strategy(rosen_hessian), objective_delta_stop_strategy(1e-7), rosen, rosen_derivative,
             starting_point, -1);
    cout << "rosen solution: \n" << starting_point << endl;
    ...
    starting_point = 0.8, 1.3;
    find_min_trust_region(objective_delta_stop_strategy(1e-7), rosen_model(), starting_point,
    ...
    find_min_using_approximate_derivatives(cg_search_strategy(), objective_delta_stop_strategy(1e-7),
                                           test_function(target), starting_point, -1);
    cout << "test_function solution:\n" << starting_point << endl;
    ...
    starting_point = -4, 5, 99, 3;
    find_min_bobyqa(test_function(target), starting_point,
