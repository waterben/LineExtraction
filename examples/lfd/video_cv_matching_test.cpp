...
int main(int argc, char** argv) {
  ...
  while (last_key_press != 'q') {
    ...
    */
    ...
    Ptr<cv::line_descriptor::BinaryDescriptorMatcher> bdm =
    ...
    */
    ...
    /*
            ...
            imshow("Detected Stereo matches", drawMatches<MyType,DescriptorMatch<MyType>>(im_grayLeft,
       lsd1.lineSegments(), im_grayRight, lsd2.lineSegments(), bfmatches2));
    */

    imshow("Detected matches, cv3 lbd matching",
           drawKeyLineMatches<FT, DescriptorMatch<FT>>(im_grayLeft, keylines1, im_grayRight, keylines2, lbdMatches));
