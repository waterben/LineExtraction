...
int main(int argc, char** argv)
{
    ...
    NonMaximaSuppression<short, int, FT, PreciseNMS<short, int, true, FT, EMap8, LinearInterpolator, Polar>> precise8i_nms;
    NonMaximaSuppression<short, FT, FT, PreciseNMS<short, FT, false, FT,EMap8, LinearInterpolator, Polar>> precise8l_nms;
    NonMaximaSuppression<short, FT, FT, PreciseNMS<short, FT, false, FT, EMap8, LinearInterpolator, PolarCV>> precise8lcv_nms;
