...
5. **Read the plot:**
   ...
   - A **broad or shifted peak** indicates the line is slightly misaligned — consider running the [Precision Optimizer](../precisionoptimizer/README.md).
...
2. **Drag the position slider** (or set the spin box) to move the sample point along the line's length. The red curve shows the cross-section at that specific position, and a green indicator line appears in the ControlWindow's plot at the sample location.
...
2. **Run the [Precision Optimizer](../precisionoptimizer/README.md)** on that line.
