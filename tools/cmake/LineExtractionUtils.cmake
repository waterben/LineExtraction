...
function(le_configure_common_settings)
    ...
    if(BUILD_DEBUG)
        ...
        if(NOT MSVC)
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fPIC -Wall -Wextra -Wpedantic -Wconversion -Wsign-conversion -Weffc++ -Wmissing-field-initializers -Wno-write-strings -Wno-comment -pg" PARENT_SCOPE)
        endif()
    else()
        set(CMAKE_BUILD_TYPE RELEASE PARENT_SCOPE)
        if(NOT MSVC)
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fPIC -Wall -Wextra -Wpedantic -Wconversion -Wsign-conversion -Weffc++ -Wmissing-field-initializers -Wno-write-strings -Wno-comment -O3 -ffast-math" PARENT_SCOPE)
        endif()
    endif()
