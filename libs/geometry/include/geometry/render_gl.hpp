...
*/
    ...
    void renderPoses3d(std::vector<lsfm::Pose<FT>> keyFramePoses){
        for_each(keyFramePoses.begin(),keyFramePoses.end(),[&](const lsfm::Pose<FT> &obj){
           renderPose3d(obj);
        });
    }
    ...
    void renderObject3d(const Object3D<FT> &obj){
        ...
        for_each(obj.triangles.begin(),obj.triangles.end(),[&](const Triangle &t){
            ...
            if((t.ta == std::size_t(0) && t.tb == std::size_t(0) && t.tc == std::size_t(0)) ||
               obj.textureCoords[t.ta][0] == 0.0 && obj.textureCoords[t.ta][1] == 0.0 &&
               obj.textureCoords[t.tb][0] == 0.0 && obj.textureCoords[t.tb][1] == 0.0 &&
               obj.textureCoords[t.tc][0] == 0.0 && obj.textureCoords[t.tc][1] == 0.0){
    ...
    void renderWireIdObjects3d(const Object3DList<FT> objs){
        ...
        for_each(objs.begin(),objs.end(),[&](const Object3D<FT> &obj){
           renderWireIdObject3d(obj, endPoints);
        });
    }

    template<class FT>
    void renderWireIdObjects3d(const Object3DList<FT> objs, std::vector<std::pair<lsfm::Vec3<FT>, lsfm::Vec3<FT>>> & endPoints){
        for_each(objs.begin(),objs.end(),[&](const Object3D<FT> &obj){
           renderWireIdObject3d(obj, endPoints);
        });
    }
...
*/
        ...
        for_each(obj.triangles.begin(),obj.triangles.end(),[&](const Triangle &t){
            ls3Tmp.push_back(lsfm::LineSegment3<FT>(lsfm::Vec3<FT>(obj.points[t.a][0], obj.points[t.a][1], obj.points[t.a][2]), lsfm::Vec3<FT>(obj.points[t.b][0], obj.points[t.b][1], obj.points[t.b][2])));
            ls3Tmp.push_back(lsfm::LineSegment3<FT>(lsfm::Vec3<FT>(obj.points[t.b][0], obj.points[t.b][1], obj.points[t.b][2]), lsfm::Vec3<FT>(obj.points[t.c][0], obj.points[t.c][1], obj.points[t.c][2])));
            ls3Tmp.push_back(lsfm::LineSegment3<FT>(lsfm::Vec3<FT>(obj.points[t.c][0], obj.points[t.c][1], obj.points[t.c][2]), lsfm::Vec3<FT>(obj.points[t.a][0], obj.points[t.a][1], obj.points[t.a][2])));
        });
        ...
        for(int i = 0; i < ls3Tmp.size(); ++i){
            ...
            if(add)
                lineSegments3.push_back(currentLineSeg3);
        }
