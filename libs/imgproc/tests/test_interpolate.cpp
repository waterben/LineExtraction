...
/// @brief Unit tests for interpolation routines.
...
class InterpolateTest : public ::testing::Test {
 protected:
  ...
  void SetUp() override {
    ...
    peak.at<float>(0, 0) = 1.0f;
    peak.at<float>(0, 1) = 2.0f;
    peak.at<float>(0, 2) = 1.0f;
    peak.at<float>(1, 0) = 2.0f;
    peak.at<float>(1, 1) = 5.0f;
    peak.at<float>(1, 2) = 2.0f;
    peak.at<float>(2, 0) = 1.0f;
    peak.at<float>(2, 1) = 2.0f;
    peak.at<float>(2, 2) = 1.0f;
