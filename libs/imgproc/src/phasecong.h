...
extern void phasecong(const emxArray_real_T *im, const emxArray_real_T *lgf,
                      const emxArray_creal_T *H, double mult, double k, double
                      cutOff, double g, double deviationGain, double noiseMethod,
                      emxArray_real_T *sumf, emxArray_real_T *sumh1,
