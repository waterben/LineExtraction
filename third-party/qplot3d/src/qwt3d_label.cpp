...
Label::Label(const QString& family, int pointSize, int weight, bool italic) { init(family, pointSize, weight, italic); }
...
void Label::useDeviceFonts(bool val) { devicefonts_ = val; }
...
*/
void Label::adjust(int gap) { gap_ = gap; }
...
double Label::width() const { return pm_.width(); }

double Label::height() const { return pm_.height(); }
