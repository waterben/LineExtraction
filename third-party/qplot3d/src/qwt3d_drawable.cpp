#include <qplot3d/qwt3d_drawable.h>

using namespace Qwt3D;

Drawable::~Drawable() { detachAll(); }
...
void Drawable::detachAll() { dlist.clear(); }
...
void Drawable::setColor(double r, double g, double b, double a) { color = RGBA(r, g, b, a); }

void Drawable::setColor(RGBA rgba) { color = rgba; }
