...
inline const Triple operator+(const Triple& t, const Triple& t2) { return Triple(t) += t2; }
inline const Triple operator-(const Triple& t, const Triple& t2) { return Triple(t) -= t2; }
...
inline double dotProduct(Triple const& u, Triple const& v) { return u.x * v.x + u.y * v.y + u.z * v.z; }
