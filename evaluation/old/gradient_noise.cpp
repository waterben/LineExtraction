...
{  
    ...
    /*filter.push_back(Entry(new DerivativeGradient<uchar,short, FT, FT, RobertsDerivative<uchar,short>>,"Roberts (2x2)", "mag"));
    filter.push_back(Entry(new DerivativeGradient<uchar, short,FT, FT, PrewittDerivative<uchar, short>>, "Prewitt (3x3)", "mag"));
    filter.push_back(Entry(new DerivativeGradient<uchar, short, FT, FT, ScharrDerivative<uchar, short>>, "Scharr (3x3)", "mag"));

    filter.push_back(Entry(new DerivativeGradient<uchar, short,FT, FT, SobelDerivative<uchar, short>>, "Sobel (3x3)", "mag"));
    filter.push_back(Entry(new DerivativeGradient<uchar, short,FT, FT, SobelDerivative<uchar, short>>({ NV("grad_kernel_size",5) }), "Sobel (5x5)", "mag"));
    filter.push_back(Entry(new DerivativeGradient<uchar, short,FT, FT, SobelDerivative<uchar, short>>({ NV("grad_kernel_size",7) }), "Sobel (7x7)", "mag"));
    filter.push_back(Entry(new DerivativeGradient<uchar, short,FT, FT, SobelDerivative<uchar, short>>({ NV("grad_kernel_size",9) }), "Sobel (9x9)", "mag"));*/

    /*filter.push_back(Entry(new DerivativeGradient<uchar, FT, FT, FT, GaussianDerivative<uchar, FT>, Magnitude<FT, FT>>({ NV("grad_kernel_size",3), NV("grad_range",1.5) }), "Gauss (3x3)", "mag"));
    filter.push_back(Entry(new DerivativeGradient<uchar, FT, FT, FT, GaussianDerivative<uchar, FT>, Magnitude<FT, FT>>({ NV("grad_kernel_size",5), NV("grad_range",2.3) }), "Gauss (5x5)", "mag"));
    filter.push_back(Entry(new DerivativeGradient<uchar, FT, FT, FT, GaussianDerivative<uchar, FT>, Magnitude<FT, FT>>({ NV("grad_kernel_size",7), NV("grad_range",3.0) }), "Gauss (7x7)", "mag"));
    filter.push_back(Entry(new DerivativeGradient<uchar, FT, FT, FT, GaussianDerivative<uchar, FT>, Magnitude<FT, FT>>({ NV("grad_kernel_size",9), NV("grad_range",3.5) }), "Gauss (9x9)", "mag"));*/
    ...
    filter.push_back(Entry(new RCMGradient<uchar, 3, short, int>(3, 1), "RCMG (3x3)", "mag", ENTRY_NO_3 | ENTRY_SQR | ENTRY_RGB));*/
    ...
    filter.push_back(Entry(dynamic_cast<Quadrature<uchar, FT, FT, FT, FT>*>(new PCLSq<uchar, FT, FT>(1, 2, 3, 1.2)), "SQF Po (3x3)", "energy"));
    filter.push_back(Entry(dynamic_cast<Quadrature<uchar, FT, FT, FT, FT>*>(new PCLSq<uchar, FT, FT>(1, 2, 5, 1.2)), "SQF Po (5x5)", "energy"));
    filter.push_back(Entry(dynamic_cast<Quadrature<uchar, FT, FT, FT, FT>*>(new PCLSq<uchar, FT, FT>(1, 2, 7, 1.2)), "SQF Po (7x7)", "energy"));
    filter.push_back(Entry(dynamic_cast<Quadrature<uchar, FT, FT, FT, FT>*>(new PCLSq<uchar, FT, FT>(1, 2, 9, 1.2)), "SQF Po (9x9)", "energy"));
    
    
    filter.push_back(Entry(dynamic_cast<Quadrature<uchar, FT, FT, FT, FT>*>(new PCLSqf<uchar, FT>(1, 3, 2.5)), "SQFF Po", "energy"));
    filter.push_back(Entry(new QuadratureLGF<uchar, FT>(5, 0.55), "SQFF Lg", "energy"));
    ...
    filter.push_back(Entry(dynamic_cast<LaplaceI<uchar, FT>*>(new PCLSqf<uchar, FT>(1.0, 2.0, 1.2)), "Laplace SQFF", "pclmag"));
