...
int main() {
...
#ifndef KERNEL_SIZE
  gradI.push_back(Entry<short, int, float>(
      new DerivativeGradient<uchar, short, int, float, RobertsDerivative, QuadraticMagnitude>, "Roberts (2x2)"));
  gradI.push_back(Entry<short, int, float>(
      new DerivativeGradient<uchar, short, int, float, PrewittDerivative, QuadraticMagnitude>, "Prewitt (3x3)"));
  gradI.push_back(Entry<short, int, float>(
      new DerivativeGradient<uchar, short, int, float, ScharrDerivative, QuadraticMagnitude>, "Scharr (3x3)"));
#endif

  gradI.push_back(Entry<short, int, float>(
      new DerivativeGradient<uchar, short, int, float, SobelDerivative, QuadraticMagnitude>, "Sobel (3x3)"));
  gradI.push_back(
      Entry<short, int, float>(new DerivativeGradient<uchar, short, int, float, SobelDerivative, QuadraticMagnitude>(
                                   {NV("grad_kernel_size", 5)}),
                               "Sobel (5x5)"));
  gradI.push_back(
      Entry<short, int, float>(new DerivativeGradient<uchar, short, int, float, SobelDerivative, QuadraticMagnitude>(
                                   {NV("grad_kernel_size", 7)}),
                               "Sobel (7x7)"));
  gradI.push_back(
      Entry<short, int, float>(new DerivativeGradient<uchar, short, int, float, SobelDerivative, QuadraticMagnitude>(
                                   {NV("grad_kernel_size", 9)}),
                               "Sobel (9x9)"));
  ...
  gradF.push_back(Entry<float, float, float>(new GradientEnergy<QuadratureG2<uchar, float, PolarCV>>(
                                                 {NV("grad_kernel_size", 3), NV("grad_kernel_spacing", 1.24008)}),
                                             "QF_StG (3x3)"));
  gradF.push_back(Entry<float, float, float>(new GradientEnergy<QuadratureG2<uchar, float, PolarCV>>(
                                                 {NV("grad_kernel_size", 5), NV("grad_kernel_spacing", 1.008)}),
                                             "QF_StG (5x5)"));
  gradF.push_back(Entry<float, float, float>(new GradientEnergy<QuadratureG2<uchar, float, PolarCV>>(
                                                 {NV("grad_kernel_size", 7), NV("grad_kernel_spacing", 0.873226)}),
                                             "QF_StG (7x7)"));
  gradF.push_back(Entry<float, float, float>(new GradientEnergy<QuadratureG2<uchar, float, PolarCV>>(
                                                 {NV("grad_kernel_size", 9), NV("grad_kernel_spacing", 0.781854)}),
                                             "QF_StG (9x9)"));
  gradF.push_back(Entry<float, float, float>(new GradientEnergy<QuadratureG2<uchar, float, PolarCV>>(
  ...
  gradF.push_back(Entry<float, float, float>(
      new GradientEnergy<QuadratureLGF<uchar, float, PolarCV>>({NV("grad_waveLength", 3), NV("grad_sigmaOnf", 0.55)}),
      "SQFF LG"));
  gradF.push_back(
      Entry<float, float, float>(new GradientEnergy<QuadratureSF<uchar, float, PolarCV>>(
  ...
  gradF.push_back(
      Entry<float, float, float>(new GradientPC<PCSqf<uchar, float, PolarCV>>(
                                     {NV("grad_scale", 1), NV("grad_muls", 2), NV("grad_kernel_spacing", 1.2)}),
                                 "PC PO"));
