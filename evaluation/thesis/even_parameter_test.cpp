...
/// @param Tests parameter optimization for even-order derivative filters
/// @param Evaluates gradient quality with different filter parameters using dlib optimization
...
double optimizeGradKernel(GRAD& grad,
  ...
  lower = d_lower;
  upper = d_upper;
  return dlib::find_min_box_constrained(search, stop, eval, dlib::derivative(eval, derivative_prec), starting_point,
                                        lower, upper);
}
...
int main(int argc, char** argv) {
  ...
  std::cout << "QuadS3 - error: " << e << ", spacing: " << quadS3.kernelSpacing() << ", scale: " << quadS3.scale()
            << ", muls: " << quadS3.muls() << std::endl;
  // std::cout << quadS3.kernel() << std::endl;

  e = optimizeGradKernel(quadS5);
  std::cout << "QuadS5 - error: " << e << ", spacing: " << quadS5.kernelSpacing() << ", scale: " << quadS5.scale()
            << ", muls: " << quadS5.muls() << std::endl;
  // std::cout << quadS5.kernel() << std::endl;

  e = optimizeGradKernel(quadS7);
  std::cout << "QuadS7 - error: " << e << ", spacing: " << quadS7.kernelSpacing() << ", scale: " << quadS7.scale()
            << ", muls: " << quadS7.muls() << std::endl;
  // std::cout << quadS7.kernel() << std::endl;

  e = optimizeGradKernel(quadS9);
  std::cout << "QuadS9 - error: " << e << ", spacing: " << quadS9.kernelSpacing() << ", scale: " << quadS9.scale()
            << ", muls: " << quadS9.muls() << std::endl;
  // std::cout << quadS9.kernel() << std::endl;

  e = optimizeGradKernel2(quadS3);
  std::cout << "QuadS3 - error2: " << e << ", spacing: " << quadS3.kernelSpacing() << ", scale: " << quadS3.scale()
            << ", muls: " << quadS3.muls() << std::endl;
  // std::cout << quadS3.kernel() << std::endl;

  e = optimizeGradKernel2(quadS5);
  std::cout << "QuadS5 - error2: " << e << ", spacing: " << quadS5.kernelSpacing() << ", scale: " << quadS5.scale()
            << ", muls: " << quadS5.muls() << std::endl;
  // std::cout << quadS5.kernel() << std::endl;

  e = optimizeGradKernel2(quadS7);
  std::cout << "QuadS7 - error2: " << e << ", spacing: " << quadS7.kernelSpacing() << ", scale: " << quadS7.scale()
            << ", muls: " << quadS7.muls() << std::endl;
  // std::cout << quadS7.kernel() << std::endl;

  e = optimizeGradKernel2(quadS9);
  std::cout << "QuadS9 - error2: " << e << ", spacing: " << quadS9.kernelSpacing() << ", scale: " << quadS9.scale()
            << ", muls: " << quadS9.muls() << std::endl;
  // std::cout << quadS9.kernel() << std::endl;
