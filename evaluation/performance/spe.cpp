...
protected:
    ...
    virtual TaskData* prepareTaskData(const std::string& src_name, cv::Mat& src) {
        prepareSource(src);
        return new SpePerformaceData<FT>(src_name, src);
    }
...
public:
    ...
    virtual void run(TaskData* data, int runs, bool verbose) {
        SpePerformaceData<FT>* pdata = dynamic_cast<SpePerformaceData<FT>*>(data);
        process(pdata->name, pdata->src, pdata->grad, pdata->nms, runs, verbose);
    }
    virtual void process(const std::string& src_name, cv::Mat src, GradFT<FT>& g, const NmsFT<FT>& n, int runs, bool verbose) = 0;
};
...
public:
    ...
    virtual void process(const std::string& src_name, cv::Mat src, GradFT<FT>& g, const NmsFT<FT>& n, int runs, bool verbose) {
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntryNearest);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeLin);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeQuad);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeCog);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeSobel);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeLinDirIpLin);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeQuadDirIpLin);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeCogDirIpLin);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeSobelDirIpLin);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeLinDirIpCubic);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeQuadDirIpCubic);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeCogDirIpCubic);
    }
};
...
public:
    ...
    static PerformanceTaskPtr create() {
        return PerformanceTaskPtr(new EntrySpeSobelDirIpCubic);
    }
};

template<class FT>
void createSPEPerformanceTest(PerformanceTestPtr& test, const DataProviderMap& provider)
{
    test.reset(new SpePerformanceTest<FT>);    
