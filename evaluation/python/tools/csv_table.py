...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="Does CSV have a header row? (default: True)",
    )
    parser.add_argument(
        "--first_col_names",
        type=bool,
        default=True,
        help="Is the first column representing names? (default: True)",
    )
    parser.add_argument(
        "--precision",
        type=int,
        default=3,
        help="Precision for numerical values (default: 3 digits)",
    )
    parser.add_argument(
        "--style",
        default="simple",
        help="Table style ('simple' or 'scientific', default: 'simple')",
    )
